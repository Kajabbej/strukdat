...
.hero { background: #0D0F12; border-radius: 20px; padding: 2.5rem; margin-bottom: 1.25rem; }
  ...
  <div class="card-grid">
    <div class="profile-card">
      ...
      <div class="card-body">
        ...
        <div class="info-item"><span class="info-key">Email</span><span class="info-val">humas@trunojoyo.ac.id</span></div>
      </div>
    </div>
    <div class="profile-card">
      <div class="card-header">
